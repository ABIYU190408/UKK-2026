                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" class="btn btn-danger btn-sm" onclick="return confirmDeleteSiswa('<?= $row['nis']; ?>')">🗑️ Hapus</a>
                                        </td>
                                    </tr>
                                <?php
                                endwhile;
   ...
   <!-- footer -->
    ...
    <script>
        function confirmDeleteSiswa(nis) {
            const result = confirm('! PERHATIAN! Yakin ingin menghapus siswa dengan NIS: ' + nis + '  Data siswa BESERTA SEMUA ASPIRASI akan DIHAPUS PERMANEN! Klik [OK] untuk menghapus atau [Cancel] untuk batal.');
            
            if (result) {
                window.location = '?delete=' + nis;
            }
            return false;
        }
    </script>
