...
if(isset($_GET['delete'])){
    ...
    // Delete dari aspirasi juga karena ada foreign key
    mysqli_query($conn, "DELETE FROM aspirasi WHERE id_pelaporan = '$id'");
    
    // Delete dari input_aspirasi
...
<body>
    ...
    <div class="main-container">
        <div class="page-header">
            <h1>📥 Data Input Aspirasi</h1>
            <p>Kelola semua input aspirasi</p>
        </div>

        <div class="table-container">
            <div class="table-header">
                <h2>Daftar Input Aspirasi</h2>
            </div>
