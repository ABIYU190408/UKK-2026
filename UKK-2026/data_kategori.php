                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="?delete=<?= $row['id_kategori']; ?>" class="btn btn-danger btn-sm" onclick="return confirmDeleteKategori(<?= $row['id_kategori']; ?>, '<?= $row['ket_kategori']; ?>')">
                                                🗑️ Hapus
                                            </a>
                                        </td>
                                    </tr>
...
<!-- Delete -->
<script>
    function confirmDeleteKategori(id, kategori) {
        const result = confirm('⚠️ PERHATIAN! Yakin ingin menghapus kategori: ' + kategori + '?\n\nData kategori BESERTA SEMUA ASPIRASI akan DIHAPUS PERMANEN!\n\nKlik [OK] untuk menghapus atau [Cancel] untuk batal.');
