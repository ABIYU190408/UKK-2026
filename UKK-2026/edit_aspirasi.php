...
if(isset($_POST['submit'])){
    ...
    if($update){
        echo '<script>alert("aspirasi berhasil dijawab !"); window.location="data_aspirasi.php"</script>';
        exit;
    } else {
        echo '<script>alert("aspirasi gagal memperbarui data!"); window.location="edit_aspirasi.php?id='.$id.'"</script>';
        exit;
    }
}
